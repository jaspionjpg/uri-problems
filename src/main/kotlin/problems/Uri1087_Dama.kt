...
fun main(args: Array<String>) {
    ...
    while (true) {
        val xAtual = ler.nextInt()
        val yAtual = ler.nextInt()
        val xDestino = ler.nextInt()
        val yDestino = ler.nextInt()
        if (xAtual == 0 && yAtual == 0 && xDestino == 0 && yDestino == 0)
            break

        if (xAtual == xDestino && yAtual == yDestino)
            println(0)
        else if (xAtual == xDestino || yAtual == yDestino || (yDestino - yAtual).absoluteValue == (xDestino - xAtual).absoluteValue)
            println(1)
        else
            println(2)
    }
