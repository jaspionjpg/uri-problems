...
fun main(args: Array<String>) {
    ...
    while (ler.hasNextInt()) {
        val numcidadoes = ler.nextInt()
        val pesquisaas = ler.nextInt()

        val cidadoes = IntArray(numcidadoes) { ler.nextInt() }.sortedDescending()

        for (i in 1..pesquisaas)
            println(cidadoes[ler.nextInt() - 1])
    }
}

/*
URI Online Judge | 2534
Exame Geral
