...
fun main(args: Array<String>) {
    ...
    var estrelasVisiveis = 0
    val minimoPupila = 40000000

    val areaAberturaTerra = ler.nextInt()
    val numeroDeEstrelas = ler.nextInt()
    for (i in 1..numeroDeEstrelas) {
        val fluxoFotosDaEstrela = ler.nextInt()

        if (fluxoFotosDaEstrela * areaAberturaTerra >= minimoPupila)
            estrelasVisiveis++
    }
    println(estrelasVisiveis)
}

/*
URI Online Judge | 2386
Telescópio
...
OBI - Olimpíada Brasileira de Informática - 2010 Fase 2 Modalidade Nível 2 (P2)
 */