...
fun main(args: Array<String>) {
    ...
    for (teste in 1..testes) {
        ...
        val numeroExclamasoes = sentenca.length.toLong() - sentenca.indexOf("!")
        val numero = sentenca.substring(0, sentenca.indexOf("!")).toLong()

        var soma = 1L
        for (i in numero downTo 1 step numeroExclamasoes) {
            soma *= i
        }
        println(soma)
    }
...
/*
URI Online Judge | 1457
Oráculo de Alexandria
XIV Maratona de Programação IME-USP  Brasil
Timelimit: 1
