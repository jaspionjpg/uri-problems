...
fun main(args: Array<String>) {
    ...
    var nomeAlunos = ArrayList<String>()
    for (i in 1..numeroDeAlunos) {
        nomeAlunos.add(ler.next())
    }
    println(nomeAlunos.sorted()[numeroSorteado-1])
}

/*
URI Online Judge | 2381
Lista de Chamada
...
OBI - Olimpíada Brasileira de Informática 2010 Fase 2 Modalidade Nível 1
 */