...
fun main(args: Array<String>) {
    ...
    val estoqueFrango = ler.nextInt()
    val estoqueBife = ler.nextInt()
    val estoqueMassa = ler.nextInt()

    val pedidoFrango = ler.nextInt()
    val pedidoBife = ler.nextInt()
    val pedidoMassa = ler.nextInt()

    var totalFaltante = 0

    if (estoqueFrango < pedidoFrango)
        totalFaltante += pedidoFrango - estoqueFrango
    if (estoqueBife < pedidoBife)
        totalFaltante += pedidoBife - estoqueBife
    if (estoqueMassa < pedidoMassa)
        totalFaltante += pedidoMassa - estoqueMassa
    println(totalFaltante)
}
