...
fun main(args: Array<String>) {
    ...
    while (ler.hasNext()) {
        var copiasNinjas: Int = ler.nextInt()
        var numeroMultiplacadores = 0
        while (copiasNinjas != 1) {
            numeroMultiplacadores++
            copiasNinjas /= 2
        }

        println(numeroMultiplacadores)
    }
}

/*
URI Online Judge | 2544
